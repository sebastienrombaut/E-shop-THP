...
Item.create(
  ...
  price: "800.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/siamois.jpeg"),
  featured: true,
  numbersales: 0
)
...
Item.create(
  ...
  price: "955.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/persan.jpeg"),
  featured: true,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1227.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/bengal.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1143.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/abyssin.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1024.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/bleu_russe.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "996.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/burmese.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1690.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/siberian.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "800.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/exotic_shorthair.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1200.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/sacre_de_birmanie.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1200.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/scottish_fold.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "871.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/cornish_rex.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1000.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/ocicat.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "900.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/norvegian.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "795.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/tonkinois.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "902.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/angora_turc.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  description: "L'angora turc est une race de chat à poils mi-longs originaire de Turquie (van). Ce chat est caractérisé par sa robe à poils mi-longs très soyeuse et sans sous-poils, et une silhouette fine qui le classe dans la catégorie des chats foreign comme l'abyssin ou le bleu russe.",
  price: "788.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/manx.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1200.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/himalayen.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1018.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/bombay.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "850.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/chartreux.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "4750.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/savannah.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "800.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/ragamuffin.jpg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "1000.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/laperm.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "950.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/cymric.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "820.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/munchkin7.jpeg"),
  featured: false,
  numbersales: 0
)
...
Item.create(
  ...
  price: "500.00",
  photo: File.open("#{Rails.root}/app/assets/images/products/dragon_li.jpeg"),
  featured: false,
  numbersales: 0
)